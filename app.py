...
def load_model():
    ...
    model = joblib.load(
        "models/forecast_rf_model_compressed.pkl"
    )
...
st.markdown(
    """
    <div class="info-box">
        <strong>Model:</strong> Forecast-ready Random Forest
        &nbsp;&nbsp;|&nbsp;&nbsp;
        <strong>Holdout MAE:</strong> 916.97
        &nbsp;&nbsp;|&nbsp;&nbsp;
        <strong>Forecast Features:</strong> 12
    </div>
    """,
    unsafe_allow_html=True
)
